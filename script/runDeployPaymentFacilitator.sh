...
echo "Deploying PaymentFacilitator contract..."
...
# Deploy the contract
forge script script/DeployPaymentFacilitator.s.sol:DeployPaymentFacilitatorScript \
  --rpc-url "$RPC_URL" \
  --broadcast \
  --verify \
  --verifier blockscout \
...
echo "2. Update your frontend with this contract address"
echo "3. Make sure your wallet has USDC and approves the PaymentFacilitator contract"